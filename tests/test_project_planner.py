...
def test_bootstrap_integration():
    ...
    t.check("BI-02: registry has 6 engines", len(registry.engines()) == 6)

    # Manager has project_planner.
    t.check("BI-03: manager count is 6", manager.count() == 6)
    ...
    t.check("BI-07: queue has 6 items", len(queue) == 6)
